...
var map = function map(val, in_min, in_max, out_min, out_max) {
  return (val - in_min) * (out_max - out_min) / (in_max - in_min) + out_min;
};

var lib_ParallaxCarousel = /*#__PURE__*/function () {
  function ParallaxCarousel(opts) {
    _classCallCheck(this, ParallaxCarousel);

    _defineProperty(this, "el", null);

    _defineProperty(this, "slider_el", null);
  ...
  _createClass(ParallaxCarousel, [{
    key: "isMobile",
    value: function isMobile() {
      return typeof this.isMobileCustom === 'undefined' ? is_mobile_default()() : this.isMobileCustom();
    }
  }, {
    key: "onResize",
    ...
    key: "onMouseAnimate",
    value: function onMouseAnimate() {
      var prev_offset = this.slider_el._offset ? this.slider_el._offset : 0;
      var offset = prev_offset + (this._mouse_offset - prev_offset) * 0.1; // to save some fps and energy while AFK
      ...
      if (Math.abs(prev_offset - offset) < 0.01) {
        ...
        this.slider_el.style.transform = "translateX(".concat(-offset, "px)");
...
;
/* harmony default export */ var lib = (lib_ParallaxCarousel);
